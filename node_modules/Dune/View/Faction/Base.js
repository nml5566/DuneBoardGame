...
function BaseFactionView(obj, args) {
  ...
  function loadBidMenuImages() 
  {
    ...
    console.log("loading bid menu images: "+bidPortraitImgUrl);
    ...
    var raiseBidImgUrl = obj.imagePath + "bid/raise_bid.png";
    images.bid.raise = loader.loadImage(raiseBidImgUrl)

    var lowerBidImgUrl = obj.imagePath + "bid/lower_bid.png";
    images.bid.lower = loader.loadImage(lowerBidImgUrl)
  }
